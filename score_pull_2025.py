...
df=pd.read_excel("/home/david/ASABE_IQS_Website/sql_management/data/2025/Scoring_Personnel_Only 2025 Master Score Spreadsheet.xlsx",sheet_name="Overall Ranking & Scores",header=2,usecols="M,O:W")
print(df.head())
