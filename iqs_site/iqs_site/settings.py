...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", SITE_CONFIG.get("EMAIL_HOST_USER", ""))
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", SITE_CONFIG.get("EMAIL_HOST_PASSWORD", ""))
